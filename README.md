...
## Day 7: Hangman 👻
This was a fun game to code! I went "above and beyond" by using requests.get to import a word list from MIT rather than just using an array of words.
...
## Day 10: Calculator 🧮
Created a calculator app. Went "above and beyond" by including exponent. In the future, may add square root (& single number support) 
